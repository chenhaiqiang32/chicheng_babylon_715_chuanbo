...
export function createIblShadowsRenderingPipeline(): IblShadowsRenderPipeline {
...
export function parseIblShadowsRenderingPipeline(editor: Editor, data: any): IblShadowsRenderPipeline {
	const iblShadowsRenderingPipeline = getIblShadowsRenderingPipeline() ?? createIblShadowsRenderingPipeline();
