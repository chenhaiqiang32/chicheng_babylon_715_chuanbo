...
import { SSAO2RenderingPipeline, Camera } from "@babylonjs/core";
...
export function createSSAO2RenderingPipeline(): SSAO2RenderingPipeline {
	ssaoRenderingPipeline = new SSAO2RenderingPipeline("SSAO2RenderingPipeline", Editor.Instance.Scene, 1.0, [Editor.Instance.Scene.activeCamera!], false);
...
export function parseSSAO2RenderingPipeline( data: any): SSAO2RenderingPipeline {
	const ssao2RenderingPipeline = getSSAO2RenderingPipeline() ?? createSSAO2RenderingPipeline();
