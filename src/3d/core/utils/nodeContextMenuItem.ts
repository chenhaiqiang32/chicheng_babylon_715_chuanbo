      ...
      subCommand: [
        {
          name: '默认粒子',
          callback: () => {
            Editor.Instance.createParticleSystem('default');
          },
        },
        {
          name: '火焰',
          callback: () => {
            Editor.Instance.createParticleSystem('fire');
          },
        },
        {
          name: '烟雾',
          callback: () => {
            Editor.Instance.createParticleSystem('smoke');
          },
        },
        {
          name: '下雨',
          callback: () => {
            Editor.Instance.createParticleSystem('rain');
          },
        },
      ],
    },
